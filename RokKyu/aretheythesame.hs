...
-- | a or b might be nil or null or None or nothing (except in C++, Crystal, D, 
...
comp as bs = undefined

test input expected =
    it (printf  "Testing %s" (show input)) $ shouldBe (uncurry comp input) expected
